<?php
/////////////coding hr_kb0002///////////////
class   hr_kb0009 extends lv_controler
{
	public $lv001 = null;
	public $lv002 = null;
	public $lv003 = null;
	...
	function LV_Aproval($lvarr)
	{
		...
		$lvsql = "Update hr_kb0002 set lv046='1',lv018=NOW()  WHERE hr_kb0002.lv001 IN ($lvarr)  ";
		$vReturn = db_query($lvsql);
		if ($vReturn) {
	...
	function LV_UnAproval($lvarr)
	{
		...
		$lvsql = "Update hr_kb0002 set lv046='2',lv014='$this->LV_UserID',lv019=now()  WHERE hr_kb0002.lv001 IN ($lvarr)  ";
		$vReturn = db_query($lvsql);
	...
	protected function GetCondition()
	{
		...
		$strCondi = $strCondi . " and (lv006=1 or lv013='') and lv046 =0";
		return $strCondi;
	}
	////////////////Count///////////////////////////
	function GetCount()
	{
		$sqlC = "SELECT COUNT(*) AS nums FROM hr_kb0002 WHERE (lv004=1 or lv013='') and lv014='$this->LV_UserID'  and lv021=0 " . $this->GetCondition();
...
";
	...
	function LV_BuilListReport($lvList, $lvFrom, $lvChkAll, $lvChk, $curRow, $maxRows, $paging, $lvOrderList)
	{
		...
		$sqlS = "SELECT * FROM hr_kb0002 WHERE lv004=1 and lv021=0  " . $this->RptCondition . " $strSort LIMIT $curRow, $maxRows";
		$vorder = $curRow;
		$bResult = db_query($sqlS);
		$this->Count = db_num_rows($bResult);
		$strTrH = "";
