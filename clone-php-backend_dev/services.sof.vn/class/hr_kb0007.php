<?php
/////////////coding hr_kb0002///////////////
class   hr_kb0007 extends lv_controler
{
	public $lv001 = null;
	public $lv002 = null;
	public $lv003 = null;
	...
	function LV_Aproval($lvarr)
	{
		...
		$lvsql = "Update hr_kb0002 set lv006='0'  WHERE hr_kb0002.lv001 IN ($lvarr) and lv046=0 and lv021=0 ";
	...
	function LV_UnAproval($lvarr)
	{
		...
		$lvsql = "Update hr_kb0002 set lv006='0'  WHERE hr_kb0002.lv001 IN ($lvarr) and lv006 = 1  ";
		$vReturn = db_query($lvsql);
		if ($vReturn) {
