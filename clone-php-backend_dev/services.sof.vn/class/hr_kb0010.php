<?php
/////////////coding hr_kb0002///////////////
class   hr_kb0010 extends lv_controler
{
	public $lv001 = null;
	public $lv002 = null;
	public $lv003 = null;
	...
	function LV_Aproval($lvarr)
	{
		...
		$lvsql = "Update hr_kb0002 set lv046='2'  WHERE hr_kb0002.lv001 IN ($lvarr)  ";
	...
	function LV_UnAproval($lvarr)
	{
		...
		$lvsql = "Update hr_kb0002 set lv046='0'  WHERE hr_kb0002.lv001 IN ($lvarr) and lv046=1  ";
		$vReturn = db_query($lvsql);
		if ($vReturn) {
			...
			if ($capDuyet == 2) {
				...
				$motc_lv0012->LV_UpdateState_1($mohr_kb0002->lv002, $ngay, $gio, "1", $this->LV_UserID);
			}
		}
	...
	function LV_BuilList($lvList, $lvFrom, $lvChkAll, $lvChk, $curRow, $maxRows, $paging, $lvOrderList, $lvSortNum)
	{
		...
		echo $sqlS = "SELECT *,DATEDIFF(lv016,lv025) SoNgayXinPhep,lv015 lv829,(DATEDIFF(lv017,lv016)+IF(LEFT(lv003,3)='1/2',0.5,1)) lv098 FROM hr_kb0002 WHERE 1=1  " . $this->GetCondition() . " $strSort LIMIT $curRow, $maxRows";
		$vorder = $curRow;
...
";
	...
	function LV_BuilListReport($lvList, $lvFrom, $lvChkAll, $lvChk, $curRow, $maxRows, $paging, $lvOrderList)
	{
		...
		$sqlS = "SELECT * FROM hr_kb0002 WHERE 1=1  " . $this->RptCondition . " $strSort LIMIT $curRow, $maxRows";
		$vorder = $curRow;
		$bResult = db_query($sqlS);
		$this->Count = db_num_rows($bResult);
		$strTrH = "";
