<?php
/////////////coding hr_kb0002///////////////
class   hr_kb0013 extends lv_controler
{
	public $lv001 = null;
	public $lv002 = null;
	public $lv003 = null;
	...
	public $lv023 = null;
	///////////
	public $DefaultFieldList = "lv001,lv015,lv129,lv002,lv003,lv022,lv016,lv017,lv009,lv010,lv030,lv021,lv008,lv039,lv040,lv023";
	////////////////////GetDate
	...
	var $ArrPush = array();
	var $ArrFunc = array();
	var $ArrGet = array("lv001" => "2", "lv002" => "3", "lv003" => "4", "lv004" => "5", "lv005" => "6", "lv006" => "7", "lv007" => "8", "lv008" => "9", "lv009" => "10", "lv010" => "11", "lv011" => "12", "lv012" => "13", "lv013" => "14", "lv014" => "15", "lv015" => "16", "lv016" => "17", "lv017" => "18", "lv018" => "19", "lv019" => "20", "lv020" => "21", "lv021" => "22", "lv022" => "23", "lv023" => "24", "lv024" => "25", "lv025" => "26", "lv099" => "100", "lv129" => "130", "lv030" => "31", "lv039" => "40", "lv040" => "41");
	...
	function LV_Aproval($lvarr)
	{
		...
		$lvsql = "Update hr_kb0002 set lv021='0'  WHERE hr_kb0002.lv001 IN ($lvarr)  ";
	...
	function LV_UnAproval($lvarr)
	{
		...
		$lvsql = "Update hr_kb0002 set lv021='0'  WHERE hr_kb0002.lv001 IN ($lvarr)  ";
		$vReturn = db_query($lvsql);
		if ($vReturn) $this->InsertLogOperation($this->DateCurrent, 'hr_kb0002.unapproval', sof_escape_string($lvsql));
		return $vReturn;
	}
	function LV_Insert()
	{
