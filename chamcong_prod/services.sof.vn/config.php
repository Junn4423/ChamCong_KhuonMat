...
define("DB_SERVER", getenv('DB_SERVER') ? getenv('DB_SERVER') : (getenv('MYSQL_HOST') ? getenv('MYSQL_HOST') : ''));
define("DB_PORT", getenv('DB_PORT') ? (int)getenv('DB_PORT') : (getenv('MYSQL_PORT') ? (int)getenv('MYSQL_PORT') : ''));
define("DB_USER", getenv('DB_USER') ? getenv('DB_USER') : (getenv('MYSQL_USER') ? getenv('MYSQL_USER') : ''));
define("DB_PWD", getenv('DB_PWD') ? getenv('DB_PWD') : (getenv('MYSQL_PASSWORD') ? getenv('MYSQL_PASSWORD') : ''));
define("DB_DATABASE", getenv('DB_DATABASE') ? getenv('DB_DATABASE') : (getenv('MYSQL_DATABASE') ? getenv('MYSQL_DATABASE') : ''));
